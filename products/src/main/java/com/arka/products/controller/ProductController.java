...
public class ProductController {
    ...
    @PostMapping
    public ResponseEntity<Mono<ProductSaveDto>> saveProduct(@Valid @RequestBody ProductDto productDto){
            return ResponseEntity.ok(productService.saveProduct(productMapper.toEntity(productDto))
